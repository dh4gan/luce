...
def plot_orbits():
    ...
    rfig.savefig('r.ps', format='ps')
    afig.savefig('a.ps', format='ps')
    efig.savefig('e.ps', format='ps')
    ifig.savefig('i.ps', format='ps')
    longfig.savefig('longascend.ps', format='ps')
    argfig.savefig('argper.ps', format='ps')
    rperfig.savefig('rperi.ps', format='ps')
    #plt.show()
